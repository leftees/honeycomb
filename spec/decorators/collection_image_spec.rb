...
RSpec.describe CollectionImage do
  ...
  let(:honeypot_image) { double(HoneypotImage, url: "http://image.image.com/image")}
  ...
  it "dislpays the first image found" do
    ...
    expect(subject.display).to eq("<div data-react-class=\"Thumbnail\" data-react-props=\"{&quot;image&quot;:&quot;http://image.image.com/image&quot;}\"></div>")
  end
